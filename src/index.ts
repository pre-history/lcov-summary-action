...
async function main() {
  ...
  console.log('🔍 Debug: PR Comment Analysis');
  ...
  if (
    ...
    console.log('📝 Entering PR comment logic...');
    ...
    try {
      ...
      console.log('🔍 Looking for existing comments...');
      ...
      const botComment = comments.data.find(
        (comment) =>
          ...
          comment.body?.includes('Generated by LCovMan 🦕'),
      );
